        ...
        <table style="width: 100%; border-collapse: separate; border-spacing: 0; margin: 25px 0; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
          <thead>
            <tr style="background-color: #f8fafc;">
              <th style="padding: 12px 10px; text-align: right; border-bottom: 2px solid #e2e8f0; color: #475569; font-size: 13px; width: 35%;">إسم الماركت</th>
              <th style="padding: 12px 10px; text-align: center; border-bottom: 2px solid #e2e8f0; color: #0f766e; font-size: 13px; width: 20%;">الأصناف المتوفرة</th>
              <th style="padding: 12px 10px; text-align: center; border-bottom: 2px solid #e2e8f0; color: #ef4444; font-size: 13px; width: 20%;">الأصناف المفقودة</th>
